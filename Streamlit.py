...
def load_bus_routes():
    bus_routes = {
        "Kerala": pd.read_csv("E:/Scrap data/datas/df_klrtc.csv")["Route_Name"].tolist(),
        "Adhra Pradesh": pd.read_csv("E:/Scrap data/datas/df_apsrtc.csv")["Route_Name"].tolist(),
        "Bihar": pd.read_csv("E:/Scrap data/datas/df_bsrtc.csv")["Route_Name"].tolist(),
        "Jammu and Kashmir": pd.read_csv("E:/Scrap data/datas/df_jksrtc.csv")["Route_Name"].tolist(),
        "Rajastan": pd.read_csv("E:/Scrap data/datas/df_rsrtc.csv")["Route_Name"].tolist(),
        "South Bengal": pd.read_csv("E:/Scrap data/datas/df_sbstc.csv")["Route_Name"].tolist(),
        "Himachal": pd.read_csv("E:/Scrap data/datas/df_hrtc.csv")["Route_Name"].tolist(),
        "patiala": pd.read_csv("E:/Scrap data/datas/df_pepsu.csv")["Route_Name"].tolist(),
        "Uttar Pradesh": pd.read_csv("E:/Scrap data/datas/df_upsrtc.csv")["Route_Name"].tolist(),
        "Kadamba": pd.read_csv("E:/Scrap data/datas/df_ktcl.csv")["Route_Name"].tolist(),
        "Chandigarh": pd.read_csv("E:/Scrap data/datas/df_cturtc.csv")["Route_Name"].tolist(),
        "North Bengal": pd.read_csv("E:/Scrap data/datas/df_nbstc.csv")["Route_Name"].tolist(),
    }
    return bus_routes
